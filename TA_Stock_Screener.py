...
st.sidebar.write("Feel free to expirement with the parameters below to see how the stock price changes.")
...
if start_date > end_date:
    st.sidebar.error("End date must fall after the start date")
...
st.write("""
    Please select a stock ticker from the dropdown menu within the S&P 500 index. \\
    Use the dropdown below to preview data and download the selected columns as a CSV file.
""")
